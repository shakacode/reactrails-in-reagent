(defproject reactrails-in-reagent "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "reactrails-in-reagent.jar"
  :jvm-opts ["-server"]
  ...
  {:uberjar {:omit-source true
   ...
   :project/dev  {:dependencies [[prone "0.8.2"]
                   ...
                   {:builds
                    {:app
                     {:source-paths ["env/dev/cljs"]
                      :compiler
                      {:main "reactrails-in-reagent.app"
                       :asset-path "/js/out"
                       :optimizations :none
                       :source-map true}}}}
                  ...
                  {:http-server-root "public"
                   ...
                   :ring-handler reactrails-in-reagent.handler/app}

                  :source-paths ["env/dev/clj"]
                  :repl-options {:init-ns reactrails-in-reagent.core}
